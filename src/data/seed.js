...
const amenities = {
  ...
  family: ['WiFi', 'Free Parking', 'Kitchen', 'Garden', 'Children Friendly', 'BBQ Grill', 'Hot Water'],
};
...
const props = [
  {
    ...
    amenities: [...amenities.town, 'Garden', 'Balcony', 'Security', 'Breakfast', 'Generator Backup', 'Self Check-in'],
    checkIn: '2:00 PM',
    checkOut: '11:00 AM',
    houseRules: [
  ...
  },
  {
    ...
    amenities: [...amenities.luxury, 'Garden', 'BBQ Grill', 'Balcony', 'Security', 'Breakfast', 'Generator Backup'],
    checkIn: '2:00 PM',
    checkOut: '12:00 PM',
    houseRules: [
      'Check-in from 2:00 PM',
  ...
  },
  {
    ...
    amenities: [...amenities.family, 'Smart TV', 'Outdoor Dining', 'Security', 'Generator Backup', 'Fireplace', 'Breakfast'],
    checkIn: '1:00 PM',
    checkOut: '10:30 AM',
    houseRules: [
  ...
  },
  {
    ...
    amenities: [...amenities.town, 'Outdoor Dining', 'Security Lights', 'Security', 'Generator Backup', 'Self Check-in', 'BBQ Grill', 'Balcony'],
    checkIn: '2:00 PM',
    checkOut: '10:30 AM',
    houseRules: [
      'Check-in from 2:00 PM',
...
function seedDatabase() {
  ...
  return {
    ...
    admins: [
      {
        id: 'admin-1',
        name: process.env.ADMIN_NAME || 'LeGrand Admin',
        email: process.env.ADMIN_EMAIL || 'admin@legrand.co.ke',
        passwordHash,
        role: 'superadmin',
      },
    ],
